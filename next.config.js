    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; img-src 'self' data: https: blob:; media-src 'self' https:; font-src 'self' https:; style-src 'self' 'unsafe-inline' https://bitrix.infoflot.com https://widgets.aviakassa.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; connect-src 'self' https://bitrix.infoflot.com https://widgets.aviakassa.com; frame-src 'self' https://bitrix.infoflot.com https://widgets.aviakassa.com;",
          },
        ],
      },
    ];
