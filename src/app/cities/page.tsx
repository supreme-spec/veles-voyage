    ...
    <>
      ...
      <div className="container mx-auto px-4 py-10 max-w-5xl">
        ...
        {/* Шапка */}
          ...
          {/* Партнёр */}
          <section className="mb-12 rounded-2xl bg-white border border-gray-200 shadow-sm p-6 sm:p-8" aria-labelledby="partners-heading">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="text-center sm:text-left">
                <h2 id="partners-heading" className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">
