...
export const metadata: Metadata = generateEnhancedSEOMetadata({
  ...
  description: 'Цены на туры на двоих в 2026 году: Турция от 100 000 ₽, Египет от 120 000 ₽, ОАЭ от 150 000 ₽, Таиланд от 180 000 ₽. Подбор туров от Велес Вояж.',
  ...
  faqs: [
    {
      ...
      answer: 'Тур в Турцию на двоих на 7 ночей все включено стоит от 100 000 ₽. Цена зависит от сезона, отеля и класса обслуживания. Летом цены выше, весной и осенью — ниже.'
    },
    {
      question: 'Сколько стоит тур в Египет на двоих?',
      answer: 'Тур в Египет на двоих на 7 ночей все включено стоит от 120 000 ₽. Хургада и Шарм-эль-Шейх предлагают доступные цены круглый год.'
    },
    {
      question: 'Какой бюджет нужен на путешествие на двоих?',
      answer: 'Минимальный бюджет на путешествие на двоих на 7 ночей: Турция — от 100 000 ₽, Египет — от 120 000 ₽, ОАЭ — от 150 000 ₽, Таиланд — от 180 000 ₽, Мальдивы — от 250 000 ₽.'
    }
  ]
});
    ...
    <div className="container mx-auto px-4 max-w-4xl py-12">
      ...
      <blockquote className="ai-citable mb-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800 border-l-4 border-green-500 rounded-r-lg">
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
          По данным экспертов Велес Вояж (РТА 0035678), средний бюджет тура на двоих на 7 ночей: Турция — от 100 000 ₽, Египет — от 120 000 ₽, ОАЭ — от 150 000 ₽, Таиланд — от 180 000 ₽, Мальдивы — от 250 000 ₽.
        </p>
      </blockquote>
