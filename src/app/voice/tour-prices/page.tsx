...
export const metadata: Metadata = generateEnhancedSEOMetadata({
  ...
  description: 'Цены на туры на двоих в 2026 году: Турция от 90 000 ₽, Египет от 85 000 ₽, ОАЭ от 120 000 ₽, Таиланд от 65 000 ₽. Подбор туров от Велес Вояж.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Тур в Египет на двоих на 7 ночей все включено стоит от 85 000 ₽. Хургада и Шарм-эль-Шейх предлагают доступные цены круглый год.'
    },
    {
      question: 'Какой бюджет нужен на путешествие на двоих?',
      answer: 'Минимальный бюджет на путешествие на двоих на 7 ночей: Турция — от 90 000 ₽, Египет — от 85 000 ₽, ОАЭ — от 120 000 ₽, Таиланд — от 65 000 ₽, Мальдивы — от 140 000 ₽.'
    }
  ]
});
  ...
  const voiceFaqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Тур в Египет на двоих на 7 ночей все включено стоит от 85 000 рублей.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Минимальный бюджет на двоих на 7 ночей: Турция от 90 000 рублей, Египет от 85 000 рублей, ОАЭ от 120 000 рублей, Таиланд от 65 000 рублей, Мальдивы от 140 000 рублей.',
        },
      },
    ],
  };
    ...
    <div className="container mx-auto px-4 max-w-4xl py-12">
      ...
      <blockquote className="ai-citable mb-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800 border-l-4 border-green-500 rounded-r-lg">
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
          Средний бюджет тура на двоих на 7 ночей: Турция — от 90 000 ₽, Египет — от 85 000 ₽, ОАЭ — от 120 000 ₽, Таиланд — от 65 000 ₽, Мальдивы — от 140 000 ₽.
        </p>
      </blockquote>
