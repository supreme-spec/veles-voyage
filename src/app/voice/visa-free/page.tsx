  ...
  faqs: [
    {
      ...
      answer: 'В 2026 году россияне могут посетить без визы более 50 стран, включая Турцию (до 90 дней), Египет (виза по прилете), ОАЭ (до 90 дней), Таиланд (до 60 дней), Мальдивы (до 30 дней), Сингапур (до 96 часов транзит) и многие другие.'
    },
    {
      question: 'Нужна ли виза в Турцию для россиян?',
      answer: 'Нет, для граждан РФ действует безвизовый режим на срок до 90 дней. Въезд возможен по загранпаспорту.'
    },
    {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'В 2026 году россияне могут посетить без визы более 50 стран, включая Турцию (до 90 дней), Египет (виза по прилете), ОАЭ (до 90 дней), Таиланд (до 60 дней), Мальдивы (до 30 дней), Вьетнам, Грузию, Кипр, Индонезию, Шри-Ланку.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Нет, для граждан РФ действует безвизовый режим на срок до 90 дней. Въезд возможен по загранпаспорту.',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="container mx-auto px-4 max-w-4xl py-12">
      ...
      <blockquote className="ai-citable mb-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800 border-l-4 border-green-500 rounded-r-lg">
        <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
          ...
          Самые популярные направления: Турция (до 90 дней), Египет (виза по прилете за $25), ОАЭ (до 90 дней), Таиланд (до 60 дней), Мальдивы (до 30 дней).
        </p>
      </blockquote>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Нет, для граждан РФ действует безвизовый режим на срок до 60 дней. Въезд возможен по загранпаспорту.
            </p>
          </div>
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
